...
# parse file
fnm = FilenameManager.from_file_numbers(3, 'spe', '../_data/spectra')  # get filename easily
...
integrated_data = file.integrate()
print(integrated_data)


# get a copy of the data, renormalized e.g. to location of the maximum of the 'counts' column.
# data_norm = file.get_normalized_data([670]*60*ureg.nm)
data_norm = file.get_normalized_data(None)
# data_norm = file.get_normalized_data([670.6]*30 + [30.2]*30)
# data_norm = file.get_normalized_data([670]*60)
# data_norm = file.get_normalized_data(file.data['energy'][666].data, 'energy', mode='linear')
# print(data_norm)
...
file.quick_plot(plot_method='linecollection', coord1='pixel', cmap='Spectral', add_legend=False)
# print(data_norm['counts'].plot(x='energy', y='time', cmap='Spectral', center=False, robust=False))
plt.show()
